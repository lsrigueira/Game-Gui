...
class Player {
	...
	// Pasase asi para saber nun futuro a IA de onde proveñen as cartas, se tes
	// poker pero está na mesa hai menos prob de ganar
	public int hasPair() {
		int puntos = 0;
	 ...
	 * ahí, non é o mesmo unha parexa de ases que de douses(hai 2 para distinguir as
